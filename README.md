# uSecure GraphQL (Beta) Wrapper

Official OpenAPI 3.0 specification for uSecure API integration with Rewst.
...
- **Version**: v0.1
- **Base URL**: `https://{your-tenant-subdomain}.api.usecure.io`
- **Authentication**: ApiKeyAuth

## Description
Generic wrapper for uSecure's invite-only GraphQL API. Requires API URL and x-api-key provided by uSecure.
